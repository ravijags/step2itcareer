        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div>
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <a href="https://www.facebook.com/profile.php?id=61592017550216" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-white/10 hover:bg-blue-600 rounded-full flex items-center justify-center transition-colors" title="Facebook">
                <svg width="14" height="14" fill="white" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.youtube.com/channel/UCOZ6YNuhMhT2waMGIhkXKoQ" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-white/10 hover:bg-red-600 rounded-full flex items-center justify-center transition-colors" title="YouTube">
              ...
              <a href="https://wa.me/message/332FS7CGCHY5N1" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-white/10 hover:bg-green-600 rounded-full flex items-center justify-center transition-colors" title="WhatsApp">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="https://wa.me/message/332FS7CGCHY5N1" className="text-sm text-green-400 hover:text-white transition-colors">WhatsApp Us</a></li>
...
function FloatingWhatsApp() {
  return (
    <a href="https://wa.me/message/332FS7CGCHY5N1" target="_blank" rel="noopener noreferrer"
      className="fixed bottom-20 md:bottom-6 right-6 z-50 w-14 h-14 bg-[#16A34A] rounded-full flex items-center justify-center shadow-deep hover:scale-110 transition-transform" aria-label="Chat on WhatsApp">
