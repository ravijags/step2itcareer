      ...
      <div className="max-w-brand mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div>
            ...
            <p className="text-xs text-white/40 mb-4">Empowering Careers. Enabling Futures.</p>
            <div className="flex gap-3">
              <a href="https://www.instagram.com/step2itcareerai_official/" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors text-xs">Instagram</a>
              <a href="https://wa.me/message/332FS7CGCHY5N1" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors text-xs">WhatsApp</a>
            </div>
          </div>
